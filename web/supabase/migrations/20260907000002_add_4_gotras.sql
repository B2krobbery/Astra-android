-- Migration: Add 4-Gotra Lineage columns to public.profiles and update discovery RPC
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS mother_father_gotra text;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS father_mother_gotra text;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS mother_mother_gotra text;

-- Update get_discovery_candidates RPC function
