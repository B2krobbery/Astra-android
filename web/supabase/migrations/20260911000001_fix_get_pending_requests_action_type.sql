-- Fix get_pending_requests RPC to check i2.action_type = 'LIKE' when filtering mutual matches
...
BEGIN
  ...
  AND NOT EXISTS (
    ...
    WHERE i2.actor_id = my_uid AND i2.target_id = p.id AND i2.action_type = 'LIKE'
  )
