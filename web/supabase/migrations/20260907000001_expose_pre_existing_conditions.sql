-- Fix: Expose pre_existing_conditions in discovery RPC
-- Previously hardcoded as NULL::text — now returns actual value so
-- the Disease pill on candidate profiles shows what the user typed.
...
BEGIN
  ...
  SELECT 
    ...
    -- FIX: Expose actual pre_existing_conditions (disease field) — visible to everyone
