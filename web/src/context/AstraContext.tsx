    ...
    try {
      ...
      if (dbProfile) {
         ...
         setUserProfile((prev: any) => ({
           ...
           gotra: dbProfile.gotra,
           motherFatherGotra: dbProfile.mother_father_gotra,
           fatherMotherGotra: dbProfile.father_mother_gotra,
           motherMotherGotra: dbProfile.mother_mother_gotra,
           ...
           healthStatus: dbProfile.health_status,
           healthCondition: dbProfile.pre_existing_conditions || '',
